...
\includegraphics[width=1.1\textwidth, keepaspectratio]{../AquiteturaDeSoftwareES/modelo_conceitual_dominio_vp1.drawio.png}
\end{adjustbox}
...
\begin{adjustbox}{center}
\includegraphics[width=1.25\textwidth, keepaspectratio]{../AquiteturaDeSoftwareES/diagrama_camadas.png}
\end{adjustbox}
...
\centering
\begin{adjustbox}{center}
\includegraphics[width=1.25\textwidth, keepaspectratio]{../AquiteturaDeSoftwareES/diagrama_implantacao.png}
\end{adjustbox}
